...
value are either 1 or 0 or some numbers. semantic of the words are same , (content of words remain same after using bag of words).
weightage of the words or sentiment of the words are not considered, they all will be converted into number(frequency of words or Binary)
...
for i in range(len(sentences)):
    review = re.sub('[^a-zA-Z]', ' ',
                    sentences[i])  # replacing all the characters apart from a - z and A - z with white space
